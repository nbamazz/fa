...
import com.craftserver.crateplugin.listeners.ThreeByThreePickaxeListener;
...
public class CratePlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new ThreeByThreePickaxeListener(this), this);
